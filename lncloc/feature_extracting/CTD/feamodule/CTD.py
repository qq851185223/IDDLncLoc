    ...
    for i in range(len(seq) - 1):
        ...
        if seq[i] == "C":
            ...
            if c == num_C:
                C4_dis = ((i * 1.0) + 1) / n
    return (
    str(num_A / n), str(num_T / n), str(num_G / n), str(num_C / n), str(AT_trans / (n - 1)), str(AG_trans / (n - 1)),
    str(AC_trans / (n - 1)), str(TG_trans / (n - 1)), str(TC_trans / (n - 1)), str(GC_trans / (n - 1)), str(A0_dis),
    str(A1_dis), str(A2_dis), str(A3_dis), str(A4_dis), str(T0_dis), str(T1_dis), str(T2_dis), str(T3_dis), str(T4_dis),
    str(G0_dis), str(G1_dis), str(G2_dis), str(G3_dis), str(G4_dis), str(C0_dis), str(C1_dis), str(C2_dis), str(C3_dis),
    str(C4_dis))
